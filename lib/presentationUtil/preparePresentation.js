...
export async function preparePresentation(mdContent, filenames, cssFilePaths, cssFilePath, cssThemePath) {
    let cssContent = await getCSSContent(cssFilePaths, cssFilePath, cssThemePath);
...
async function getCSSContent(cssFilePaths, cssFilePath, cssThemePath) {
