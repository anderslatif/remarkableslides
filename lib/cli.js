...
.option('--spell-check', 'Enables spell checking on the markdown files. Default language is `en`.')
.option('---spell-check-language <language>', 'Allows you to define a language for spell checking. ');
